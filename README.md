...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.6.2/fixi.js >> fixi-0.6.2.js
```

The SHA256 of v0.6.2 is 

`ZJpupP1V7BwGB2z1qJtFdrqfudIWNTUi18desZr/IJE=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.6.2.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.6.2/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-ZJpupP1V7BwGB2z1qJtFdrqfudIWNTUi18desZr/IJE="></script>
```
