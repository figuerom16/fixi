...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.9.0/fixi.js >> fixi-0.9.0.js
```

The SHA256 of v0.9.0 is 
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.9.0.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.9.0/fixi.js"
