...
The current uncompressed size is `3163` bytes, the gzipped size is `1342` bytes and the brotli'd size is `1135` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.8/fixi.js >> fixi-0.5.8.js
```

The SHA256 of v0.5.8 is 

`y1+2yPTmtYwNfQ3gUt6AwHSREDg7cX6InmLcdwlFsGw=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.8.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.8/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-y1+2yPTmtYwNfQ3gUt6AwHSREDg7cX6InmLcdwlFsGw="></script>
```
