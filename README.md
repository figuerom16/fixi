...
The current uncompressed size is `3183` bytes, the gzipped size is `1347` bytes and the brotli'd size is `1148` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.9/fixi.js >> fixi-0.5.9.js
```

The SHA256 of v0.5.9 is 

`SXxhT2qZDAr01N/OXOa9mM/LaCmmi4RtJwXQsA/T/RE=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.9.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.9/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-SXxhT2qZDAr01N/OXOa9mM/LaCmmi4RtJwXQsA/T/RE="></script>
```
