...
The current uncompressed size is `3324` bytes, the gzipped size is `1403` bytes and the brotli'd size is `1189` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.6.3/fixi.js >> fixi-0.6.3.js
```

The SHA256 of v0.6.3 is 

`bDSR90ncwDTEMCCZPl22nYmAlbCVSEu5Jslshx0VQ60=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.6.3.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.6.3/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-bDSR90ncwDTEMCCZPl22nYmAlbCVSEu5Jslshx0VQ60="></script>
```
