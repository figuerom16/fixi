...
The current uncompressed size is `3193` bytes, the gzipped size is `1347` bytes and the brotli'd size is `1137` bytes,
as determined by:
...
The SHA256 of v0.5.7 is 

`tSPKuqY8/DK4iKM0Ja0BNt9w3QNPh6UZU3m4uYwTayM=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.7.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.7/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-tSPKuqY8/DK4iKM0Ja0BNt9w3QNPh6UZU3m4uYwTayM="></script>
```
